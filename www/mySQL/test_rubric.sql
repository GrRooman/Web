...
CREATE TABLE IF NOT EXISTS `goods` (
  ...
  CONSTRAINT `FK_goods_price` FOREIGN KEY (`price_id`) REFERENCES `price` (`price_id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Дамп данных таблицы test_rubric.goods: ~18 rows (приблизительно)
...
-- Дамп данных таблицы test_rubric.price: ~54 rows (приблизительно)
...
-- Дамп данных таблицы test_rubric.rubrics_goods: ~18 rows (приблизительно)

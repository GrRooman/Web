...
$APPLICATION->SetPageProperty("keywords_inner", "Условия сотрудничества");
...
<tr>
	<td>
		<p>
			<img width="191" alt="Изображение коробочной версии 1С-Битрикс:Управление сайтом" src="/upload/medialibrary/bff/bffbe3e81fb3b0f4ebaf091a6b183713.png" height="191" title="Изображение коробочной версии 1С-Битрикс:Управление сайтом">&nbsp; &nbsp;
		</p>
		<p>
		</p>
	</td>
...
<p>
 ...
 На основании данных из анкеты партнера мы принимаем решение о возможности установления партнерских отношений. Мы так же хотели бы видеть ваш полноценный работающий корпоративный сайт с указанием ваших контактов и перечнем предлагаемых услуг. Партнерская программа&nbsp;
<p>
	 предназначена для студий дизайна, разработчиков сайтов, интеграторов и всех тех, кто профессионально занимается разработкой веб-решений для конечных клиентов.
</p>
<p>
